...
class ArsipSuratKeluarController extends Controller
{
  ...
  $validatedData = $request->validate([
    ...
    'urutan_surat_keluar' => 'required|integer|min:1',
    ...
    'urutan_surat_keluar.required' => 'Urutan dokumen wajib diisi.',
    'urutan_surat_keluar.integer' => 'Urutan harus berupa angka.',
    'urutan_surat_keluar.min' => 'Urutan minimal 1.',
