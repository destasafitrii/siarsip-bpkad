    ...
    <div class="navbar-header">
        ...
        <div class="navbar-logo-box">
            ...
            <a href="index.html" class="logo logo-light">
                ...
                <span class="logo-lg">
                    <img src="{{url('public')}}/assets/images/logo-light.png" alt="logo-light" height="18">
                </span>
            </a>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn btn-sm top-icon p-0" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded avatar-2xs p-0" src="{{url('public')}}/assets/images/users/avatar-6.png" alt="Header Avatar">
                    </button>
