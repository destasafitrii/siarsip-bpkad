<header class="header_area">
    <nav class="navbar navbar-expand-lg menu_one menu_purple sticky-nav">
      <div class="container">
        <a class="navbar-brand header_logo" href="{{url ('public')}}/frontend/index.html">
          <img class="first_logo sticky_logo" src="{{url ('public')}}/frontend/img/logo.png" srcset="{{url ('public')}}/frontend/img/logo-ktp.png 2x" alt="logo" style="width: 50px; height: auto;">
          <img class="white_logo main_logo" src="{{url ('public')}}/frontend/img/logo-w.png" srcset="{{url ('public')}}/frontend/img/logo-ktp.png 2x" alt="logo" style="width: 50px; height: auto;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav menu ml-auto">
            <li class="nav-item dropdown submenu active">
              ...
              {{-- <ul class="dropdown-menu">
                ...
                <li class="nav-item active"><a href="index-classic.html" class="nav-link">Classic Helpdesk</a></li>
              </ul> --}}
            </li>
          ...
          {{-- <div class="right-nav">
            <a class="nav_btn not-round-btn" href="#">Free Trail</a>
          </div> --}}
        </div>
      </div>
    </nav>
