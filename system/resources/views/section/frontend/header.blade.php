<nav class="navbar navbar-expand-lg menu_one menu_purple sticky-nav">
            <div class="container">
                <a class="navbar-brand header_logo" href="index.html">
                    <img class="first_logo sticky_logo" src="{{url('public')}}/frontend/img/logo.png" srcset="{{url('public')}}/frontend/img/logo-2x.png 2x" alt="logo">
                    <img class="white_logo main_logo" src="{{url('public')}}/frontend/img/logo-w.png" srcset="{{url('public')}}/frontend/img/logo-w2x.png 2x" alt="logo">
                </a>
