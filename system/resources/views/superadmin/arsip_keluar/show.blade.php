            ...
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-header bg-white text-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('superadmin.arsip_keluar.index') }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>OPD</th>
                                        <td>{{ $arsip_surat_keluar->opd->nama_opd ?? 'Tidak Diketahui' }}</td>
                                    </tr>
                                    <tr>
                                        <th>No Surat</th>
                                    ...
                                    <tr>
                                        <th>Tanggal</th>
                                        <td>{{ \Carbon\Carbon::parse($arsip_surat_keluar->tanggal_surat_keluar)->format('d-m-Y') }}</td>
                                    </tr>
                                    <tr>
                                        <th>Bidang</th>
