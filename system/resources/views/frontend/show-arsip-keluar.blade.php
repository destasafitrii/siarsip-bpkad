...
<div class="container py-5 position-relative" style="margin-top: 100px; background: linear-gradient(to right, #002454, #4f6d9d); color: white; border-radius: 15px; padding: 40px;"> 
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="text-center flex-grow-1" style="color: white; font-weight: 600;">Detail Arsip Surat Keluar</h5>
    ...
    <div class="card shadow-lg p-4 mb-4" style="background-color: #ffffff; color: #333333; border-radius: 15px;">
        <div class="row">
            ...
            <div class="col-md-6">
                <h6 class="mb-3"><strong>Nama Surat:</strong> {{ $arsip->nama_surat_keluar }}</h6>
                <p class="mb-3"><strong>No Surat:</strong> {{ $arsip->no_surat_keluar }}</p>
                <p class="mb-3"><strong>Bidang:</strong> {{ $arsip->bidang->nama_bidang }}</p>
                <p class="mb-3"><strong>Kategori:</strong> {{ $arsip_surat_keluar->kategori->nama_kategori ?? 'Tidak Diketahui' }}</p>
            </div>
            <div class="col-md-6">
                <p class="mb-3"><strong>Lokasi:</strong> {{ $arsip->lokasi_surat_keluar }}</p>
                <p class="mb-3"><strong>No Berkas:</strong> {{ $arsip->no_berkas_surat_keluar }}</p>
                <p class="mb-3"><strong>Urutan:</strong> {{ $arsip->urutan_surat_keluar }}</p>
                <p class="mb-3"><strong>Keterangan:</strong> {{ $arsip->keterangan_surat_keluar }}</p>
            </div>
        </div>
    </div>
