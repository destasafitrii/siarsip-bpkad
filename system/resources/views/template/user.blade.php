...
<style>
    body {
        ...
        background: linear-gradient(135deg, #18915f, #176894); /* Gradasi hijau pastel ke oranye lembut */
        min-height: 100vh;
        overflow-x: hidden;
        position: relative;
    }
    ...
    /* Tambahan bentuk dan posisi blur */
    .decor-top-left {
        top: -100px;
        left: -100px;
    }
...
<div id="layout-wrapper">
    ...
    <!-- Start topbar -->
   @include('section.backend.userheader')
    <!-- End topbar -->
