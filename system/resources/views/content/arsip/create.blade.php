...
<div class="page-content">
                        ...
                        <form action="{{ route('arsip.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="bidang" name="bidang" required>
                                    ...
                                    <option value="pembendaharaan" {{ old('bidang') == 'pembendaharaan' ? 'selected' : '' }}>Pembendaharaan</option>
                                    <option value="akuntansi" {{ old('bidang') == 'akuntansi' ? 'selected' : '' }}>Akuntansi</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tujuan_dari" name="tujuan_dari" value="{{ old('tujuan_dari') }}" required>
                            </div>

                            <div class="mb-3">
                                <label for="no_berkas" class="form-label">Nomor Berkas</label>
                                <input type="text" class="form-control" id="no_berkas" name="no_berkas" value="{{ old('no_berkas') }}" required>
                            </div>

                            <div class="mb-3">
                                <label for="urutan" class="form-label">Urutan</label>
                                <input type="number" class="form-control" id="urutan" name="urutan" value="{{ old('urutan') }}" required>
                            </div>
    ...
    {{-- <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Edit Data Arsip</h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('arsip.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="tanggal" class="form-label">Tanggal</label>
                        <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ old('tanggal', $arsip->tanggal) }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="bidang" name="bidang" required>
                            <option value="">Pilih Bidang</option>
                            <option value="anggaran" {{ old('bidang', $arsip->bidang) == 'anggaran' ? 'selected' : '' }}>Anggaran</option>
                            <option value="pembendaharaan" {{ old('bidang', $arsip->bidang) == 'pembendaharaan' ? 'selected' : '' }}>Pembendaharaan</option>
                            <option value="akuntansi" {{ old('bidang', $arsip->bidang) == 'akuntansi' ? 'selected' : '' }}>Akuntansi</option>
                            <option value="sekretariat" {{ old('bidang', $arsip->bidang) == 'sekretariat' ? 'selected' : '' }}>Sekretariat</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="jenis_arsip" name="jenis_arsip" required>
                            <option value="">Pilih Jenis Arsip</option>
                            <!-- Opsi akan diisi berdasarkan bidang yang dipilih dengan JavaScript -->
                            <option value="opsi1" {{ old('jenis_arsip', $arsip->jenis_arsip) == 'opsi1' ? 'selected' : '' }}>Opsi 1</option>
                            <option value="opsi2" {{ old('jenis_arsip', $arsip->jenis_arsip) == 'opsi2' ? 'selected' : '' }}>Opsi 2</option>
                    ...
                    <div class="mb-3">
                        <label for="tujuan_dari" class="form-label">Tujuan/Dari</label>
                        <input type="text" class="form-control" id="tujuan_dari" name="tujuan_dari" value="{{ old('tujuan_dari', $arsip->tujuan_dari) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="no_berkas" class="form-label">Nomor Berkas</label>
                        <input type="text" class="form-control" id="no_berkas" name="no_berkas" value="{{ old('no_berkas', $arsip->no_berkas) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="urutan" class="form-label">Urutan</label>
                        <input type="number" class="form-control" id="urutan" name="urutan" value="{{ old('urutan', $arsip->urutan) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="lokasi" class="form-label">Lokasi</label>
                        <input type="text" class="form-control" id="lokasi" name="lokasi" value="{{ old('lokasi', $arsip->lokasi) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="keterangan" class="form-label">Keterangan</label>
                        <textarea class="form-control" id="keterangan" name="keterangan">{{ old('keterangan', $arsip->keterangan) }}</textarea>
                    </div>

                    <button type="submit" class="btn btn-primary">Update</button>
                    <a href="{{ route('arsip.index') }}" class="btn btn-secondary">Batal</a>
                </form>
                <!-- End Form Edit Data Arsip -->
            </div>
        </div>
    </div> <!-- end col --> --}}
    </div>      <!-- end row -->
