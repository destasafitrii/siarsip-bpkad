                        ...
                        <div class="card-body">
                            <form action="{{ route('arsip.update', $arsip->arsip_id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_arsip" class="form-control" id="nama_arsip"
                                        value="{{ $arsip->nama_arsip }}" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="bidang" name="bidang" required>
                                        ...
                                        <option value="anggaran" {{ $arsip->bidang == 'anggaran' ? 'selected' : '' }}>
                                            Anggaran</option>
                                        <option value="pembendaharaan"
                                            {{ $arsip->bidang == 'pembendaharaan' ? 'selected' : '' }}>Pembendaharaan
                                        </option>
                                        <option value="akuntansi" {{ $arsip->bidang == 'akuntansi' ? 'selected' : '' }}>
                                            Akuntansi</option>
                                        <option value="sekretariat" {{ $arsip->bidang == 'sekretariat' ? 'selected' : '' }}>
                                            Sekretariat</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="jenis_arsip" name="jenis_arsip" required>
                                        ...
                                        @if ($arsip->bidang == 'anggaran')
                                            <option value="APBD" {{ $arsip->jenis_arsip == 'APBD' ? 'selected' : '' }}>
                                                APBD</option>
                                        @elseif($arsip->bidang == 'pembendaharaan')
                                            <option value="SPD" {{ $arsip->jenis_arsip == 'SPD' ? 'selected' : '' }}>SPD
                                            </option>
                                            <option value="SP2D" {{ $arsip->jenis_arsip == 'SP2D' ? 'selected' : '' }}>
                                                SP2D</option>
                                        @elseif($arsip->bidang == 'akuntansi')
                                            <option value="SPJ" {{ $arsip->jenis_arsip == 'SPJ' ? 'selected' : '' }}>SPJ
                                            </option>
                                        @elseif($arsip->bidang == 'sekretariat')
                                            <option value="masuk" {{ $arsip->jenis_arsip == 'masuk' ? 'selected' : '' }}>
                                                Masuk</option>
                                            <option value="keluar" {{ $arsip->jenis_arsip == 'keluar' ? 'selected' : '' }}>
                                                Keluar</option>
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tujuan_dari" class="form-control" id="tujuan_dari"
                                        value="{{ $arsip->tujuan_dari }}" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="urutan" class="form-control" id="urutan"
                                        value="{{ $arsip->urutan }}" required>
                                </div>

                                <div class="mb-3">
                                    <label for="lokasi" class="form-label">Lokasi</label>
                                    <input type="text" name="lokasi" class="form-control" id="lokasi"
                                        value="{{ $arsip->lokasi }}" required>
                                </div>
